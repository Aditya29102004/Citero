...
const About = () => {
  return (
    <div className="bg-white min-h-screen">
      <SEO
        title="About citero - AI Visibility Tracking Platform | Learn How We Help Brands"
        description="Learn about citero, the leading AI visibility tracking platform. We help brands understand and optimize how they appear in AI-generated responses across ChatGPT, Gemini, Claude, and Perplexity."
        keywords="about citero, AI visibility platform, GEO tracking company, AI brand monitoring, Generative Engine Optimization"
        canonical="https://citero.ai/about"
      />
      <HomeHeader />
          ...
          <div className="prose prose-gray max-w-none space-y-8">
            <section>
              <p className="text-xl text-gray-700 leading-relaxed mb-6">
                citero is the leading AI visibility tracking platform that helps brands understand and optimize how they appear 
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                citero provides comprehensive GEO (Generative Engine Optimization) scanning and analytics:
              </p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">Why citero?</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                citero uses advanced AI scanning technology to query multiple AI models with brand-related questions, analyze 
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Ready to take control of your brand's AI visibility? Join our waitlist to get early access to citero and start 
